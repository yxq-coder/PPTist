 ...
 * src: pdf地址
 */
export interface PPTPdfElement extends PPTBaseElement {
  type: 'pdf';
  src: string;
  scale: number;
}
...
export type PPTElement = PPTTextElement | PPTImageElement | PPTShapeElement | PPTLineElement | PPTChartElement | PPTTableElement | PPTLatexElement | PPTVideoElement | PPTAudioElement | PPTPdfElement
