  ...
  <div class="editor-header">
    <div class="left">
      <Dropdown :trigger="['click']">
        ...
        <template #overlay>
          <Menu>
            <MenuItem @click="save()">保存</MenuItem>
            <!--
      ...
      <Dropdown :trigger="['click']">
        ...
        <template #overlay>
          <Menu>
            ...
            <MenuItem @click="resetSlides()">重置页面</MenuItem>
          </Menu>
        </template>
      </Dropdown>
      <Dropdown :trigger="['click']">
        <div class="menu-item"><IconPpt /> <span class="text">预览</span></div>
        <template #overlay>
          <Menu>
...
export default defineComponent({
  ...
  setup() {
    ...
    const { disableHotkeys, showGridLines, showRuler } = storeToRefs(mainStore)
