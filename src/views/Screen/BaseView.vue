<template>
  <div class="base-view" :class="{ 'laser-pen': laserPen }">
    ...
    >
      <div class="content">
        <div class="tool-btn page-number" @click="slideThumbnailModelVisible = true">页面 {{slideIndex + 1}} / {{slides.length}}</div>
        ...
        <Tooltip :mouseLeaveDelay="0" :mouseEnterDelay="0.3" title="结束预览">
  ...
  setup(props) {
    ...
    const contextmenus = (): ContextmenuItem[] => {
      return [
        ...
        { divider: true },
        {
          text: autoPlayTimer.value ? '取消自动预览' : '自动预览',
